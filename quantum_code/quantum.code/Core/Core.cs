...
namespace Quantum
{
    ...
    public unsafe partial class Frame : Core.FrameBase
    {
        ...
        {
            get { return &_globals->RngSession; }
        }
        ...
        {
            get { return _sessionConfig.PlayerCount; }
        }
        ...
        /// </summary>
        public SystemBase[] SystemsAll
        {
            get { return _systemsAll; }
        }

        /// <summary>
        /// See <see cref="SimulationRate"/>. This getter acquires the value from the <see cref="SessionConfig"/> though.
        /// </summary>
        public override int UpdateRate
        {
            get { return _sessionConfig.UpdateFPS; }
        }

        /// <summary>
        /// Globally access the physics settings which are taken from the <see cref="SimulationConfig"/> during the Frame constructor.
        /// </summary>
        public sealed override PhysicsSceneSettings* PhysicsSceneSettings
        {
            get { return &_globals->PhysicsSettings; }
        }
...
namespace Quantum
{
    ...
    public partial class SimulationConfig : AssetObject
    {
        ...
        /// </summary>
        [Space] public Navigation.Config Navigation;

        /// <summary>
        /// Global physics configurations.
        /// </summary>
        [Space] public PhysicsCommon.Config Physics;

        /// <summary>
        /// Global entities configuration
        /// </summary>
        [Space] public FrameBase.EntitiesConfig Entities;
        ...
        /// </summary>
        [EnumFlags] [Tooltip("Additional options for checksum dumps, if the default settings don't provide a clear picture. ")]
    ...
    public unsafe struct AssetRefSimulationConfig : IEquatable<AssetRefSimulationConfig>
    {
        ...
        [FieldOffset(0)] public AssetGuid Id;
...
namespace Quantum
{
    public partial class TypeRegistry
    {
        ...
        {
            get { return new ReadOnlyDictionary<Type, int>(_types); }
        }
...
namespace Quantum
{
    public class SessionContainer
    {
        ...
        {
            get { return _startGameTimeoutInMiliseconds; }
            set { _startGameTimeoutInMiliseconds = value; }
        }

        #region Obsolete Members

        [Obsolete("Renamed to Session")] public DeterministicSession session;
        [Obsolete("Renamed to SessionConfig")] public DeterministicSessionConfig config => _sessionConfig;
        [Obsolete("Renamed to RuntimeConfig")] public RuntimeConfig runtimeConfig => _runtimeConfig;
...
namespace Quantum
{
    public abstract partial class SystemBase
    {
        ...
        {
            get { return (Int32)_runtimeIndex; }
            set
            {
        ...
        public SystemBase ParentSystem
        {
            ...
            internal set { _parentSystem = value; }
        }

        public virtual IEnumerable<SystemBase> ChildSystems
        {
            get { return new SystemBase[0]; }
        }
